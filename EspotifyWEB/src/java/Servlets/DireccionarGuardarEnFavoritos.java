 ...
 * @author Leandro
 */
public class DireccionarGuardarEnFavoritos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(getEstado(request)){
                ...
                case LOGIN_CORRECTO:
                    ...
                    request.getRequestDispatcher("/WEB-INF/GuardarEnFavoritos/JSPtipoFavorito.jsp").forward(request,response);
                    break;
                case LOGIN_INVITADO:
