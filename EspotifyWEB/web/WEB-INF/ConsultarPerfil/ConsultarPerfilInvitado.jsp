...
<html lang="en">
    ...
    <body>
        ...
        <form action="consultarPerfilComoInvitado" method="POST">   
            ...
            <% List<Usuario> usuario = (List<Usuario>) request.getAttribute("usrs");%>
                <% Iterator it=usuario.iterator();
                Usuario u;
                while(it.hasNext()){
                    u=(Usuario) it.next(); %>
                    <input type="radio" name= "ConsultarUsuario" value= <% out.print(u.getNick());%>> <% out.print(u.getNick());%></br> 
                 <%}%>   
            </aside>
            </br>
            <input type="button" class="boton" name="boton1" value="Consultar" onclick="submit()">    
