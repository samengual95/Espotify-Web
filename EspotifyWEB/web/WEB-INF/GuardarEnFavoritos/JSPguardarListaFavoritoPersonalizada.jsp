...
<html>
    ...
    <body>
        ...
        <div class="container">
            <p><h2>Guardar lista en favoritos</h2><br></p>
            <form action="GuardarListaPersonalizadaFavorito" method="POST">
                <p><input type="text" name="nombreArtista" placeholder="Nick o mail del artista" required></p>
                <p><input type="text" name="nombreLista" placeholder="Nombre de la lista" required></p>
            <p>
