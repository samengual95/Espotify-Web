...
<html>
    <head>
        ...
        <title>Actualizar estado de suscripcion</title>
        <style>
            header{
                background: #2c3e50;
                color:#fff;
    ...
    <body>
        ...
        <div class="container">
            <p><h2>Actualizar estado de suscripcion</h2><br></p>
            <form action="actualizarEstadoSuscripcion" method="POST">
               <input type="button" class="boton" value="paso" onclick="submit()">
            </p>
        </div>
        <footer>
            <div class="container">
