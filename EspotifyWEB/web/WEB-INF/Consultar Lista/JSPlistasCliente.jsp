...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="datosListaCliente" method="POST">
                <% ArrayList<String> listas = (ArrayList<String>) request.getSession().getAttribute("listasper");%>
                <% Iterator<String> it=listas.iterator();
                String g;
                while(it.hasNext()){
                    g= it.next(); %>
                    <input type="radio" name= "consultarListaCliente" value= "<% out.print(g);%>"> <% out.print(g);%></br> 
                 <%}%>  
                <br>
