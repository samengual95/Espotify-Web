    ...
    <body>
        <header>
            <%
                ...
                ArrayList<String> artistas =(ArrayList<String>) request.getSession().getAttribute("artistas");
        ...
        <div class="container">
            ...
            <p><h3>Seleccione el artista</h3><br></p>
            <form action="consultarAlbum" method="POST">
                  <% Iterator<String> it = artistas.iterator();
                      String s;
                      while (it.hasNext()) {
                        s =  it.next();%>
                  <input type="radio" name= "Artistas" value= <% out.print(s);%>><% out.print(s);%></br>
                <%}%>
                <br>
