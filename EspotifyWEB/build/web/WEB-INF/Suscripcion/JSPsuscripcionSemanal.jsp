...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="ConfirmarSuscripcion" method="POST">
                <p>El monto de la suscripcion semanal es de: $100</p>
                <p>
                    <input type="button" class="boton" value="Confirmar" onclick="submit()">
                </p>
        </div>
        <footer>
            <div class="container">
