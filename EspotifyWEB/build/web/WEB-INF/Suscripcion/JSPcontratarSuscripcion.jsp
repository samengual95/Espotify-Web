...
<html>
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
            <title>Contratar suscripcion</title>
        <style>
            header{
                background: #2c3e50;
                color:#fff;
    ...
    <body>
        ...
        <div class="container">
            <p><h2>Contratar Suscripcion</h2><br></p>
            <form action="ContratarSuscripcion" method="POST">
                <p><input type="radio" name="tipoSuscripcion" value="semanal"> Semanal</br></p>
                <p><input type="radio" name="tipoSuscripcion" value="mensual"> Mensual</br></p>
                <p><input type="radio" name="tipoSuscripcion" value="anual"> Anual</br></p>
                <p>
