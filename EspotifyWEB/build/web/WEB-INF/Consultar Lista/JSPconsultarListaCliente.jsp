<%@page import="dataType.DtListaReproduccionPersonalizada"%>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form method="POST">   <% DtListaReproduccionPersonalizada variable = (DtListaReproduccionPersonalizada) request.getSession().getAttribute("lista");%>
                <p>AUTOR:<% out.print(variable.getClienteAutor()); %> </p>
                <p>NOMBRE: <% out.print(variable.getNombre()); %> </p>
                <p>PRIVADA: <% out.print(variable.isPrivada()); %> </p>
