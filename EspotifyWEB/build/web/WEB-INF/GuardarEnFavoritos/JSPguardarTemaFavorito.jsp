...
<html>
    ...
    <body>
        ...
        <div class="container">
            <p><h2>Guardar tema en favoritos</h2><br></p>
            <form action="GuardarTemaFavorito" method="POST">
                <p><input type="text" name="nombreArtista" placeholder="Nick o mail del artista" required></p>
                <p><input type="text" name="nombreAlbum" placeholder="Nombre del album" required></p>
                <p><input type="text" name="numeroCancion" placeholder="Numero de la cancion en el album" required></p>
            <p>
