...
<html>
    ...
    <body>
        ...
        <div class="container">
            <p><h2>Guardar en favoritos</h2><br></p>
            <form action="tipoFavorito" method="POST">
                <input type="radio" name= "seleccionarTipo" value="Tema"> Tema</br> 
                <input type="radio" name= "seleccionarTipo" value="Album"> Album</br> 
                <input type="radio" name= "seleccionarTipo" value="ListaPersonalizada"> Lista personalizada</br>
                <input type="radio" name= "seleccionarTipo" value="ListaPorDefecto"> Lista por defecto</br></br></br>
            <p>
